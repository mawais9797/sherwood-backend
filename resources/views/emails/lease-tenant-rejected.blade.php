                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>Your lease application for the rental listing at {{ $content['property_address'] }} has been declined.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0;">
                                                    <p>If you'd like to revise the terms, please reach out to the landlord to further discuss.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0;">
