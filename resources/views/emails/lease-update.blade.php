                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>Your lease for the {{ $content['listing_type'] }} listing at {{ $content['property_address'] }} has been updated by the landlord. Please navigate to the Leases page to review the changes.
                                                      </p>
