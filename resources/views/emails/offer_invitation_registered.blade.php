                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>You have been invited by {{ $content['invite_by'] }} to join the offer for the rental listing at {{ $content['property_address'] }}. If you’d like to accept this invitation, please click the link below to complete your application to move forward with the offer.</p>
                                                </td>
                                            </tr>
