                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>We regret to inform you that your rental listing at {{ $content['property_address'] }} has been declined by the tenant(s).</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0;">
                                                    <p>If you are open to revising the terms, please reach out to the tenant(s) to further discuss.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0;">
