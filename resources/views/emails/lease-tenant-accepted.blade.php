                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>Congratulations! Your lease application has been completed for the rental listing at {{ $content['property_address'] }}.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0;">
                                                    <p>Your lease will commence on {{ $content['start_date'] }} and end on {{ $content['end_date'] }}. Your first payment is due five (5) days from today. Subsequent payments will be due the first of the month. All charges will be reflected and payments transacted through Loftus. </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0;">
