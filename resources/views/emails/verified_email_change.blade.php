                                ...
                                <td style="width: 100%; padding: 20px; box-sizing: border-box;">
                                    <table style="width: 100%; border-spacing: 0;">
                                        <tbody>
                                            ...
                                            @if (!empty($content['new_email']) && $content['new_email'] == 1)
                                                <tr>
                                                    <td style="padding: 0;">
                                                        <p>Hi {{ $content['email_to_name'] }}!</p>
                                                        <p>Your email address has been successfully updated. This email will be associated with your Loftus account. All future correspondence will be sent to your this email address.</p>
                                                    </td>
                                                </tr>
                                            @endif
                                            @if (!empty($content['old_email']) && $content['old_email'] == 1)
                                                <tr>
                                                    <td style="padding: 0;">
                                                        <p>Hi {{ $content['email_to_name'] }}!</p>
                                                        <p>Your email address has been successfully updated. This email is no longer associated with your Loftus account. All future correspondence will be sent to your new email address.</p>
                                                    </td>
                                                </tr>
                                            @endif
                                            <tr>
