                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>You have been invited by {{ $content['sender'] }} to execute the lease for the rental listing at {{ $content['property_address'] }}. If you’d like to accept this invitation, please click the link below to review and sign the lease.</p>
                                                </td>
                                            </tr>
