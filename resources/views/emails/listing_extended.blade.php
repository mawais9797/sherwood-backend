                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>Your {{ $content['listing_type'] }} listing for address {{ $content['property_address'] }} has been extended from {{ $content['old_expiry_date'] }} to {{ $content['new_expiry_date'] }}. If you would like to extend the listing at any point prior to expiry, please visit the listing on Loftus and extend it there or simply click the button below. 
                                                      </p>
