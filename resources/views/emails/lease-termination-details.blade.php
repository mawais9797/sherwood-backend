                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>This is a notification to inform you that the landlord will be terminating your rental lease at {{ $content['property_address'] }} on {{$content['termination_date']}}. Additional details of this termination, including potential fees, can be found on the Lease page. Please reach out to the landlord directly for any questions that you may have.
                                                      </p>
