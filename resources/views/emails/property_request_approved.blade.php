                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>Thank you for your patience as we reviewed your property transfer request for {{ $content['property_address'] }}. After careful examination, we have successfully approved your request. You’re now the sole account holder for this property on the Loftus platform. Please log in to your account and edit the property details accordingly. </p>
