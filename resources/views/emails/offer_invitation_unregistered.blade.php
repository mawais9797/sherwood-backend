                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>You have been invited by {{ $content['invite_by'] }} to join the offer for the rental listing at {{ $content['property_address'] }}. If you’d like to accept this invitation, please complete the following steps:</p>
                                            ...
                                            @if (!empty($content['link']))
                                                <tr>
                                                    <td style="padding: 0;">
                                                        <p>2. Navigate to the Offers page to complete your application
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <tr>
                                                <td style="padding: 0;">
                                                    <p>If you received this invitation by mistake or do not want to accept, please disregard this email or decline the offer.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0;">
