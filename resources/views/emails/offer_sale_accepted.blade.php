                                                ...
                                                <td style="padding: 0;">
                                                    <p>Hi {{ $content['email_to_name'] }}!</p>
                                                     @if (!empty($content['status']) && $content['status']=='accepted')
                                                        <p>Congratulations! Your offer for the sale listing at {{ $content['property_address'] }} has been accepted! Please connect with the seller and/or your realtor to take the next steps in closing on the home.</p>
                                                    @endif
                                                    @if (!empty($content['status']) && $content['status']=='rejected')
                                                        <p>We regret to inform you that your offer for the sale listing at {{ $content['property_address'] }} has been declined. </p>
                                                        <p>If you’d like to further pursue the listing, please reach out to the seller to discuss alternative terms. We’re sorry this offer was not successful but wish you the best in future offers!</p>
                                                    @endif
                                                </td>
                                            </tr>
