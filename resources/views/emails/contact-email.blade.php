    ...
    <table
        ...
        <tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>A new query submitted by <b>{{ $content['sender_name'] }}</b>.
                                                    </p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="font-size: 15px; line-height: 20px;">
                                                    Email: <b>{{ $content['mem_data']['email'] }}</b>
                                                </td>
                                            </tr>
                                            ...
                                            {{-- <tr>
                                                <td style="font-size: 15px; line-height: 20px;">
                                                    Company: <b>{{ $content['mem_data']['company_name'] }}</b>
                                </td>
                            </tr> --}}

                            {{-- <tr>
                                                <td style="font-size: 15px; line-height: 20px;">
                                                    Subject: <b>{{ $content['mem_data']['subject'] }}</b>
                </td>
            </tr> --}}
            <tr>
                <td style="font-size: 15px; line-height: 20px;">
                    Message: <b>{{ $content['mem_data']['message'] }}</b>
                </td>
            </tr>
            ...
            {{-- <tr>
                                                <td style="font-size: 15px; line-height: 20px;">
                                                    Date:
                                                    <b>{{ format_date($content['mem_data']['created_at'], 'M d, Y') }}</b>
            </td>
            </tr> --}}
            ...
            {{-- <tr>
                                                <td style="padding: 0; text-align: center;">
                                                    <a href="{{ $content['link'] }}"
            style="display: inline-block; text-align: center; margin-bottom: 10px; background: #ff6c40; color: #fff; text-decoration: none; padding: 10px 30px; border-radius: 50px; font-weight: 500;">{{ $content['code'] }}</a>
            </td>
            </tr> --}}
            ...
            <tr>
                <td style="padding: 0;">
                    {{-- <p>Questions? Check out our <a
                                                            href="{{ config('app.react_url') }}/faq">Frequently Asked
                    Questions</a>.</p> --}}
                    <p>Sincerely,<br>
