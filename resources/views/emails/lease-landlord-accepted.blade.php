                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>Congratulations! Your rental listing at {{ $content['property_address'] }} has been accepted by the tenant(s).</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0;">
                                                    <p>This lease will commence on {{ $content['start_date'] }} and end on {{ $content['end_date'] }}. The tenants' first payment will be due in five (5) days and subsequent charges will be reflected on Loftus on the first of the month. </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0;">
