                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 0;">
                                                    ...
                                                    <p>Your {{ $content['listing_type'] }} listing for address {{ $content['property_address'] }} has expired. If you would like to relist this property, please visit the listings page in Loftus and create a new listing there or simply click the button below.
                                                      </p>
                                            ...
                                            @if (!empty($content['link']))
                                                <tr>
                                                    <td style="padding: 0; text-align: center;">
                                                        <a href="{{ $content['link'] }}"
                                                            style="display: inline-block; text-align: center; margin-bottom: 10px; background: #ff6c40; color: #fff; text-decoration: none; padding: 10px 30px; border-radius: 50px; font-weight: 500;">Create Listing</a>
                                                    </td>
                                                </tr>
                                            @endif
                                             <tr>
