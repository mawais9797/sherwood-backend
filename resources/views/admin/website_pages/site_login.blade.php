                ...
                <div class="row">
                    <div class="col">
                        <div>
                            ...
                            <input class="form-control" id="page_title" type="text" name="page_title" placeholder="" value="{{ $sitecontent['page_title'] }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div>
                            ...
                            <input class="form-control" id="meta_title" type="text" name="meta_title" placeholder="" value="{{ $sitecontent['meta_title'] }}">
                        </div>
                    </div>
                </div>
                <div class="row">
