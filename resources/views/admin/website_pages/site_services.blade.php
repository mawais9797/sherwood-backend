                                                ...
                                                <div class="col">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            ...
                                                            {{ $how_works }}</label>
                                                        <input class="form-control" id="section1_text{{ $i }}"
                                                            type="text" name="section1_text{{ $i }}"
                                                            placeholder=""
                                                            value="{{ !empty($sitecontent['section1_text' . $i]) ? $sitecontent['section1_text' . $i] : '' }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
