...
<form class="form theme-form" method="post" action="" enctype="multipart/form-data" id="saveForm">
        ...
        <div class="card-body">
            ...
            <div class="row">
                    ...
                    <div class="card w-100 border position-relative overflow-hidden">
                        <div class="card-body p-4">
                            <div class="text-center">
                                ...
                                <p class="mb-0">Allowed JPG, GIF or PNG. Max size of 800K</p>
                                <input class="form-control uploadFile" name="image6" type="file" data-bs-original-title="" title="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3">
                            <label class="form-label" for="section2_btn_text"> Button Text</label>
                            <input class="form-control" id="section2_btn_text" type="text" name="section2_btn_text" placeholder="" value="{{ !empty($sitecontent['section2_btn_text']) ? $sitecontent['section2_btn_text'] : "" }}">
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-3">
                            <label class="form-label" for="section2_btn_link"> Button Link</label>
                            <input class="form-control" id="section2_btn_link" type="text" name="section2_btn_link" placeholder="" value="{{ !empty($sitecontent['section2_btn_link']) ? $sitecontent['section2_btn_link'] : "" }}">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <?php $how_work = 0; ?>
        @for ($i = 7; $i <= 10; $i++) <?php $how_work = $how_work + 1; ?> <div class="col-lg-6">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="section5_heading" type="text" name="section5_heading" placeholder="" value="{{ !empty($sitecontent['section5_heading']) ? $sitecontent['section5_heading'] : "" }}">
                            </div>
                        </div>
    ...
    <div class="row">
        <?php $use_case = 0; ?>
        @for ($i = 1; $i <= 3; $i++) <?php $use_case = $use_case + 1; ?> <div class="col-lg-4">
            <div class="card">

                <div class="card-header">
                    <h5>Use Case {{ $use_case }}</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label class="form-label" for="sec5_heading{{ $i }}">Heading
                                    {{ $use_case }}</label>
                                <input class="form-control" id="sec5_heading{{ $i }}" type="text" name="sec5_heading{{ $i }}" placeholder="" value="{{ !empty($sitecontent['sec5_heading' . $i]) ? $sitecontent['sec5_heading' . $i] : "" }}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label class="form-label" for="sec5_text{{ $i }}">Text
                                    {{ $use_case }}</label>
                                <textarea id="sec5_text{{ $i }}" name="sec5_text{{ $i }}" rows="8" class="form-control">{{ !empty($sitecontent['sec5_text' . $i]) ? $sitecontent['sec5_text' . $i] : "" }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
                ...
                <div class="col">
                    <div class="card w-100 border position-relative overflow-hidden">
                        <div class="card-body p-4">
                            <div class="text-center">
                                <div class="file_choose_icon">
                                    <img src="{{ get_site_image_src('images', !empty($sitecontent['image11']) ? $sitecontent['image11'] : "") }}" alt="matdash-img" class="img-fluid ">
                                </div>
                                <p class="mb-0">Allowed JPG, GIF or PNG. Max size of 800K</p>
                                <input class="form-control uploadFile" name="image11" type="file" data-bs-original-title="" title="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="section6_heading" type="text" name="section6_heading" placeholder="" value="{{ !empty($sitecontent['section6_heading']) ? $sitecontent['section6_heading'] : "" }}">
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="mb-3">
                        <label class="form-label" for="section6_features">Features</label>
                        <textarea id="section6_features" name="section6_features" rows="4" class=" editor">{{ !empty($sitecontent['section6_features']) ? $sitecontent['section6_features'] : "" }}</textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div class="mb-3">
                        <label class="form-label" for="section6_btn_text"> Button Text</label>
                        <input class="form-control" id="section6_btn_text" type="text" name="section6_btn_text" placeholder="" value="{{ !empty($sitecontent['section6_btn_text']) ? $sitecontent['section6_btn_text'] : "" }}">
                    </div>
                </div>
                <div class="col">
                    <div class="mb-3">
                        <label class="form-label" for="section6_btn_link"> Button Link</label>
                        <input class="form-control" id="section6_btn_link" type="text" name="section6_btn_link" placeholder="" value="{{ !empty($sitecontent['section6_btn_link']) ? $sitecontent['section6_btn_link'] : "" }}">
                    </div>
                </div>
            </div>
        </div>
