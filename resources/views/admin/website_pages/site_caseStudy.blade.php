                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="banner_btn1_txt">Button Text</label>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="banner_btn1_link">Button Link URL</label>
                                    <input type="text" class="form-control" name="banner_btn1_link" id="banner_btn1_link"
                                        value="{{ $sitecontent['banner_btn1_link'] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <h5>Button 2</h5>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="banner_btn2_txt">Button Text</label>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="banner_btn2_link">Button Link URL</label>
                                    <input type="text" class="form-control" name="banner_btn2_link"
                                        id="banner_btn2_link" value="{{ $sitecontent['banner_btn2_link'] ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table text-nowrap mb-0 newTable" id="newTable">
                        ...
                        <tbody>
                            <!-- start row -->
                            @php
                                $sec1s = getMultiText('caseStudy-section2');
                            @endphp
                                    ...
                                    <tr class="search-items">
                                        <td>
                                            <div class="d-flex align-items-center" id="imgDiv">
                                                <input type="file" name="sec2_image[]" accept="image/*"
                                                ...
                                                <input type="hidden" name="sec2_pics[]" value="<?= $sec1->image ?>">
                                            </div>
                                        </td>
                                        <td>
                                            <input type="text" name="sec2_title[]" id="sec1_title"
                                                value="<?= $sec1->title ?>" class="form-control" placeholder="Text">
                                        </td>
                                        <td>
                                            <textarea name="sec2_txt1[]" id="sec_txt5" class="form-control" rows="3"><?= $sec1->txt1 ?></textarea>
                                        </td>
                                        <td>
                                            <input type="number" name="sec2_order_no[]" id="sec1_order_no"
                            ...
                            @else
                                <tr class="search-items">
                                    <td>
                                        <div class="d-flex align-items-center" id="imgDiv">
                                            <input type="file" name="sec2_image[]" accept="image/*" id="newImgInput"
                                                style="display: none;" />
                                    ...
                                    <td>
                                        <input type="text" name="sec2_title[]" id="sec1_title" value=""
                                            class="form-control" placeholder="Text">
                                    </td>
                                    <td>
                                        <textarea name="sec2_txt1[]" id="sec_txt5" class="form-control" rows="3"></textarea>
                                    </td>
                                    <td>
                                        <input type="number" name="sec2_order_no[]" id="sec1_order_no" value=""
