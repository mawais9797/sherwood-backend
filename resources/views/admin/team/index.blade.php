                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" rows="3" name="meta_description">{{ !empty($row) ? $row->meta_description : '' }}</textarea>
                                </div>

                                <div class="col-md-6">
                                    <label for="meta_keywords" class="form-label">Meta Keyword</label>
                                    <textarea class="form-control" rows="3" name="meta_keywords">{{ !empty($row) ? $row->meta_keywords : '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<table id="zero_config" class="table table-striped table-bordered text-nowrap align-middle">
    ...
    <tbody>
        ...
        <tr>
            ...
            <!-- <td>
                <h6> {!! getFeatured($row->featured) !!}</h6>
            </td> -->
            <td>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-3"
                                href="{{ url('admin/team/edit/' . $row->id) }}">
                                <i class="fs-4 ti ti-edit"></i>Edit
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-3"
                                href="{{ url('admin/team/delete/' . $row->id) }}"
